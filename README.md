...
本中為[Lemonade Stand](https://github.com/nayafia/lemonade-stand)的繁體中文翻譯版本。

譯注：Lemonade Stand指銷售檸檬汁的小攤，在美國往往是由小孩經營。原文作者 Nadia Eghbal 想藉由「為了賺點零用錢，努力擺攤賣起檸檬水」衍生解釋各式透過開放原始碼專案獲利的方式，以及後續的效益。
...
* 會在專案中產生不合理的激勵機制（低質量的pull request也會影響專案的專注性）
* 通常沒多少錢 (小於 500 美元)
* 無法提供持久的收入
...
如果你的專案已經有了一定的死忠支持者，你可協助廣告商向你的支持者進行推銷。通常你的專案都會有明確的死忠支持者，這是你的優勢也是廣告商所喜歡的。（比如你有一個Python專案，那麼基本上可以假定你的死忠支持者一定是技術上熟悉Python的）
